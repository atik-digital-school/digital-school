...
export default function KioskHome() {
  ...
  const mockLocations: Location[] = [
    ...
    { id: '7', name: 'Kabinet 7', roomNumber: '7', floor: 'Prízemie', type: 'classroom', description: 'Kabinet' },
    ...
    { id: '15', name: 'Kabinet 15', roomNumber: '15', floor: '1. poschodie', type: 'classroom', description: 'Kabinet' },
    ...
    { id: '20', name: 'Kabinet 20', roomNumber: '20', floor: '2. poschodie', type: 'classroom', description: 'Kabinet' },
    ...
    { id: '25', name: 'Kabinet 25', roomNumber: '25', floor: '3. poschodie', type: 'classroom', description: 'Kabinet' },
